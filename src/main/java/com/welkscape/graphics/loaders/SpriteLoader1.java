package com.welkscape.graphics.loaders;
...
import com.welkscape.DataUtils;
...
public class SpriteLoader1 {
	...
	public static void loadSprites() {
		try {
			String dir = Signlink.getCacheDirectory();
			Stream index = new Stream(FileOperations.readFile(dir + "media_archives/media_archive1.idx"));
